...
def preprocessar_pagamentos(uploaded_file):
    ...
    try:
        ...
        df_pagamentos.columns = [col.strip().replace(' ', '_').replace('º', 'o').replace('ç', 'c').replace('ã', 'a').replace('ú', 'u').replace('á', 'a').replace('é', 'e').replace('í', 'i').replace('ó', 'o').replace('ü', 'u').replace('ñ', 'n').replace('.', '').replace('(', '').replace(')', '').replace('/', '').replace('\\', '').replace('-', '_') for col in df_pagamentos.columns]
